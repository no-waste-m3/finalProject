  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <ProtectedRoute
            /*onlyFor={{access: 'buyer', path:'/home/dashboard'}}*/ element={
              <motion.div initial={initial} exit={exit} animate={animation}>
                <Home />
              </motion.div>
            }
          />
      ...
      <Route
        ...
        element={
          <ProtectedRoute
            onlyFor={{ access: "seller", path: "/home" }}
            element={
              <motion.div initial={initial} exit={exit} animate={animation}>
                <Dashboard />
              </motion.div>
      ...
      <Route
        path="signUp"
        element={<NonProtectedRoute element={<SignUp />} />}
      />
      <Route
        path="*"
        element={
